    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Our AI tool automatically removes backgrounds from images, helping
          creators <br className="max-sm:hidden"/> and businesses produce professional visuals quickly
          and effortlessly.
        </p>
        <div>
